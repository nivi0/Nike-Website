...
const Footer = () => {
  return (
    <footer className="max-container">
      ...
      max-lg:flex-col text-white-400">
        ...
        items-start">
          ...
          sm:max-w-sm">Get shoes ready for the new 
            term at your nearest Nike 
            store. Find your perfect size 
        ...
        cursor-pointer text-white-400">Terms & Conditions</p>
      </div>
    </footer>
  )
}
